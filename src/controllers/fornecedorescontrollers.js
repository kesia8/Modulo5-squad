import { bdFornecedor } from '../infra/bd.js'
...
class fornecedorController {
    ...
    static rotas(app) {
        ...
        app.get('/Fornecedor/cod/:cod', fornecedorController.buscarPorCod)
        app.post('/Fornecedor', fornecedorController.inserir)
        app.put('/Fornecedor/id/:id', fornecedorController.atualizarFornecedor)
        app.delete('/Fornecedor/cod/:cod', fornecedorController.deletar)
